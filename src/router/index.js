...
export const constantRoutes = [
  ...
  // },
  {
    path: '/whatsapp-tracking',
    component: Layout,
    redirect: '/whatsapp-tracking/index',
    children: [
      {
        path: 'index',
        component: () => import('@/views/guide/index'),
        name: 'Whatsapp Tracking',
        meta: { title: 'Whatsapp Tracking', icon: 'eye-open', noCache: true }
      }
    ]
  },
  {
    path: '/whatsapp-blast',
    component: Layout,
    redirect: '/whatsapp-blast/index',
    children: [
      {
        path: 'index',
        component: () => import('@/views/guide/index'),
        name: 'Whatsapp Blast',
        meta: { title: 'Whatsapp Blast', icon: 'form', noCache: true }
      }
    ]
  },
  // {
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/table/data-table/user'),
        name: 'Data User',
        meta: { title: 'Data User', icon: 'user', noCache: true }
      }
    ]
  },
  // {
